      ...
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-border bg-card/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs font-medium text-muted-foreground">
            ...
            <Button size="sm" onClick={() => navigate("/analysis")} className="ml-2">
              Start Analysis
            </Button>
          </div>

          <Button size="sm" className="md:hidden" onClick={() => navigate("/analysis")}>
            Start Analysis
          </Button>
        </div>
      </nav>
      ...
      <section id="hero" className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <Button size="lg" onClick={() => navigate("/analysis")} className="gap-2 text-sm">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="panel rounded-xl p-6 hover:glow-cyan transition-shadow duration-300 group"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {outputs.map(({ title, desc }) => (
              <div key={title} className="panel rounded-xl p-5 text-center">
